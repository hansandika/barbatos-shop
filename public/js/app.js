...
var themeToggleLightIcon1 = document.getElementById('theme-toggle-light-icon1'); // Change the icons inside the button based on previous settings
...
themeToggleBtn1.addEventListener('click', function () {
  ...
  themeToggleLightIcon1.classList.toggle('hidden'); // if set via local storage previously
