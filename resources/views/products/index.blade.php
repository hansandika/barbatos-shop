<x-app-layout title="List Products">
    <div class="w-full screenL dark:bg-gray-900 ">
        <p class="font-semibold text-gray-700 dark:text-gray-200 text-xl md:text-3xl pb-2 pt-4 px-5 md:px-10">
            ...
            @forelse ($products as $product)
                <a href="{{ route('products.show', $product->id) }}" class="cursor-pointer">
                    <div
                        ...
                        <img class="object-cover p-4 h-[340px] w-full" src="{{ $product->image }}" alt="product image" />
